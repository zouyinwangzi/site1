...
<div class='reveal-modal blocking-modal welcome-modal' id='terms_of_service_modal'>
	...
	<div class="pvl">
		<a id="get_started" onclick="document.getElementById('get_started').innerHTML='<?php printf( __( 'Setting up...', 'shareaholic' ) ); ?>';document.getElementById('get_started').classList.add('btn_main_busy');" class="btn_main" style="margin-top: -20px;"><?php printf( __( 'Get Started →', 'shareaholic' ) ); ?></a>
		<p style="margin-bottom: 20px;"><small style="font-size:12px; color: rgb(136, 136, 136);"><?php printf( __( 'By clicking "Get Started" you agree to Shareholic\'s %1$sTerms of Service%2$s and %3$sPrivacy Policy%4$s.', 'shareaholic' ), '<a href="https://www.shareaholic.com/terms/?src=wp_admin" target="_new">', '</a>', '<a href="https://www.shareaholic.com/privacy/?src=wp_admin" target="_new">', '</a>' ); ?></small>
		</p>
	</div>
