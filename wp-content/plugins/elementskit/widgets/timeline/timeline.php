...
class ElementsKit_Widget_timeline extends Widget_Base {
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Line Break', 'elementskit'),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__('Keep TimleLine open? ', 'elementskit'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'elementskit'),
				'label_off' => esc_html__('No', 'elementskit'),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'flex-start',
				'selectors' => [
					'{{WRAPPER}}  {{CURRENT_ITEM}} .timeline-item.media' => 'align-items:{{VALUE}};',
				],
				'condition' => [
					'ekit_timeline_style' => 'vertical',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Inactive Title Color ', 'elementskit'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Pinpoint', 'elementskit'),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Pinpoint Icon Size (px)', 'elementskit'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Pinpoint Height & Width (px)', 'elementskit'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
       ...
       <?php endif;
        ...
        if($settings['ekit_timeline_style'] == 'horizontal') { 
            if($settings['ekit_timeline_horizontal_style'] == 'top'){ ?>
                ...
                <div class="single-timeline <?php echo esc_attr($content['ekit_timeline_hover_acitve'] === 'yes' ? 'hover' : ''); ?> elementor-repeater-item-<?php echo esc_attr( $content[ '_id' ] ); ?>">
