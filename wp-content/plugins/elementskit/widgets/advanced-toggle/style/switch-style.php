<div class="ekit-slide-toggle-wraper">
    <div class="ekit-switch-nav-wraper-outer" role="tablist">
        <label class="nav nav-tabs ekit-slide-toggle" id="nav-tab-<?php echo esc_attr($this->get_id()); ?>">
        <?php 
            $toggleItem = 0;
    ...
    <div class="tab-content" id="nav-tabContent-<?php echo esc_attr( $this->get_id() ); ?>">
    <?php 
        $toggleContent = 0;
        ...
        >   
            <div class="animated fadeIn">
                <?php
					...
					echo \ElementsKit_Lite\Modules\Controls\Widget_Area_Utils::parse( $toggle['ekit_toggle_content'], $this->get_id(), ($item + 1), $ekit_ajax_template ); 
