...
class ElementsKit_Widget_Twitter_Feed extends Widget_Base {
    ...
    protected function render_raw( ) {
		   ...
		   <?php
				...
				?>
					<p class="ekit-twitter-error"> <?php esc_html_e( isset($timeline['errors'][0]['message']) ? $timeline['errors'][0]['message'] : 'Invalid author', 'elementskit'); //phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText ?> </p>
				<?php
					return ;
				}
				if( isset($timeline['error']) ){
				?>
					<p class="ekit-twitter-error"> <?php esc_html_e( isset($timeline['error']) ? $timeline['error'] : 'Invalid author', 'elementskit'); //phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText ?> </p>
				<?php
					return ;
				}
			?>
									...
									<div class="ekit-twitter-feed-content-wraper">
										...
										<div class="ekit-twitter-feed-header">
											...
											<div class="ekit-twitter-logo">
												<a href="<?php echo esc_url($statusUrlPrefix . $twitter['id_str']); ?>" target="_blank"><i class="icon icon-twitter"></i></a>
											</div>
										</div>
										<?php endif;?>

										<!--Start test description-->
										<p class="feed-title"><?php echo \ElementsKit_Lite\Utils::render($this->str_check($twitter['text'])); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> </p>
										<?php
										if($ekit_twitter_feed_show_media == 'yes'):
											...
											<div class="ekit-twitter-media">
												<a href="<?php echo esc_url( $statusUrlPrefix . $twitter['id_str']); ?>" target="_blank">
										...
										<div class="read-more-button">
											<a href="<?php echo esc_url($statusUrlPrefix . $twitter['id_str']); ?>" target="_blank"> <?php esc_html_e('More', 'elementskit'); ?> </a>
										</div>
										<?php endif;?>
										<!--End read more-->
