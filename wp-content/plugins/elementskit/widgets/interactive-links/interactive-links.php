...
class ElementsKit_Widget_Interactive_Links extends Widget_Base {
    ...
    protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show Icon On Hover & Active', 'elementskit' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'elementskit'),
				'label_off' => esc_html__('No', 'elementskit'),
				'return_value' => '1',
				'selectors' => [
					'{{WRAPPER}} .ekit-interactive-links-list-link-title-container :is(i, svg)' => 'opacity: 0; transition: all 0.4s ease; transform: translateX(0px);',
					'{{WRAPPER}} .ekit-interactive-links-list-link:hover .ekit-interactive-links-list-link-title-container :is(i, svg)' => 'opacity: {{VALUE}}; transform: translateX(3px);',
					'{{WRAPPER}} .ekit-interactive-links-list-link.ekit-interactive-active .ekit-interactive-links-list-link-title-container :is(i, svg)' => 'opacity: {{VALUE}}; transform: translateX(3px);',//show icon on active link
				],
				'condition' => [
					'ekit_interactive_links_icon[value]!' => ''
				]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Image Width', 'elementskit' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%'],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-wid-con .ekit-interactive-links-list-link-title-container' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Image Height', 'elementskit' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%'],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-wid-con .ekit-interactive-links-list-link-title-container' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
