...
class ElementsKit_Widget_Vertical_Menu extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'ekit_vertical_toggle_icon_heading',
            [
        ...
        $this->add_control(
        'ekit_vertical_toggle_icon_alingment',
            [
                'label' => __( 'Icon Alignment', 'elementskit' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .ekit-vertical-menu-tigger .vertical-menu-right-icon' => 'margin-top: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .ekit-vertical-menu-tigger .vertical-menu-left-icon' => 'margin-top: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_tabs(
            ...
            $this->add_group_control(
                Group_Control_Background::get_type(),
                [
                    'name' => 'ekit_vertical_menu_items_background',
                    'label' => __( 'Background', 'elementskit' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .ekit-vertical-navbar-nav>li>a',
                ]
            ...
            $this->add_group_control(
                Group_Control_Background::get_type(),
                [
                    'name' => 'ekit_vertical_menu_items_background_active',
                    'label' => __( 'Background', 'elementskit' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .ekit-vertical-navbar-nav>li:hover>a',
                ]
            );
        ...
        $this->add_control(
            'ekit_vertical_menu_items_border_radius',
            [
                'label' => esc_html__('Border Radius', 'elementskit'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .ekit-vertical-navbar-nav>li' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        // Badge
        $this->start_controls_section(
            'ekit_vertical_menu_badge_style_tab',
            [
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'ekit_vertical_menu_badge_typography',
                'label' => __('Typography', 'elementskit'),
                'selector' => '{{WRAPPER}} .ekit-vertical-navbar-nav .ekit-menu-badge',
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'ekit_vertical_menu_badge_border',
                'label' => __('Border', 'elementskit'),
                'selector' => '{{WRAPPER}} .ekit-vertical-navbar-nav .ekit-menu-badge',
            ]
        );
        ...
        $this->add_control(
            'ekit_vertical_menu_badge_border_radius',
            [
                'label' => esc_html__('Border Radius', 'elementskit'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .ekit-vertical-navbar-nav .ekit-menu-badge' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );

        $this->add_control(
            'ekit_vertical_menu_badge_padding',
            [
                'label' => esc_html__('Padding', 'elementskit'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .ekit-vertical-navbar-nav .ekit-menu-badge' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );

        $this->add_control(
            'ekit_vertical_menu_badge_margin',
            [
                'label' => esc_html__('Margin', 'elementskit'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .ekit-vertical-navbar-nav .ekit-menu-badge' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
