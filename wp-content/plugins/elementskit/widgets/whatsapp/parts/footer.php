<div class="elementskit-whatsapp__input <?php echo esc_html($footer_class); ?>">
	<div class="elementskit-whatsapp__input--wrapper">
		<?php if($ekit_whatsapp_footer_style == "button"): ?>
			<a href="https://wa.me/<?php echo esc_attr($whatsapp_number); ?>" target='<?php echo esc_attr($ekit_whatsapp_footer_link_target) ?>' class="elementskit-whatsapp__input--button">
		...
		<?php else : ?>
			...
			<a href="https://wa.me/<?php echo esc_attr($whatsapp_number); ?>" class="elementskit-whatsapp__input--btn" aria-label="massage-sent">
