		...
		?>
			<header id="masthead" itemscope="itemscope" itemtype="https://schema.org/WPHeader">
				<div class="ekit-template-content-markup ekit-template-content-header">
					<?php echo \ElementsKit\Utils::render_elementor_content($this->header); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> 
				</div>
			</header>
			<style>
				[data-type="header"] {
	...
	// footer actions
	  public function add_plugin_footer_markup(){
			...
			do_action('elementskit/template/before_footer'); ?>
				...
				<?php echo \ElementsKit\Utils::render_elementor_content($this->footer); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				</footer>
