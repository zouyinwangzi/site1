...
if(!function_exists( 'hfe_render_header' )){
    function hfe_render_header(){
        ...
        echo '<div class="ekit-template-content-markup ekit-template-content-header">';
            echo \ElementsKit\Utils::render_elementor_content($elementskit_template_ids[0]); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        echo '</div>';
...
if(!function_exists( 'hfe_render_footer' )){
    function hfe_render_footer(){
        ...
        do_action('elementskit/template/before_header');
        echo '<div class="ekit-template-content-markup ekit-template-content-header">';
            echo \ElementsKit\Utils::render_elementor_content($elementskit_template_ids[1]); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        echo '</div>';
        do_action('elementskit/template/after_header');
    }
}
