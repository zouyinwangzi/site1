...
$inner_help .= '<div class="fns-hidden-videos"><p><a href="https://www.youtube.com/watch?v=HM8sSz9xsbg&ab_channel=wp-centrics" target="_blank" alt="See video on YouTube" class="fns-video-link"><img src="' . WC_FNS_URL . 'assets/img/video-1b.png" width="232" height="130" /><span>General overview</span></a>';
$inner_help	.= '<a href="https://www.youtube.com/watch?v=sjQKbt2Nn7k&ab_channel=wpcentrics" target="_blank" alt="See video on YouTube" class="fns-video-link"><img src="' . WC_FNS_URL . 'assets/img/video-2.png" width="232" height="130" /><span>Short tutorial</span></a>';
$inner_help .= '<a href="https://www.youtube.com/watch?v=myhFc-NmMO8&ab_channel=wp-centrics" target="_blank" alt="See video on YouTube" class="fns-video-link"><img src="' . WC_FNS_URL . 'assets/img/video-3b.png" width="232" height="130" /><span>Shipping boxes</span></a></p></div>';
//			  . '</div>';
