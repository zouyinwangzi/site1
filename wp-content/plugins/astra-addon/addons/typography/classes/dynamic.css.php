...
function astra_typography_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	$css_output = array(
		 ...
		 * Widget Content
		 */
		astra_parse_selector( '.widget-area.secondary .sidebar-main .wp-block-heading, #secondary .widget-title, .woocommerce-page #secondary .widget .widget-title', 'wc' ) => array(
