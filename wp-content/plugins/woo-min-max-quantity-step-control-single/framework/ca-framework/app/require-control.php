...
if( ! class_exists( 'CA_Framework\Require_Control' ) ){
    ...
    class Require_Control extends Notice_Base
    {
        ...
        {
            if( $this->status == 'install' ) return __( 'to be Install and Activated.', 'woo-min-max-quantity-step-control-single' );
            if( $this->status == 'activate' ) return __( 'to be Activated.', 'woo-min-max-quantity-step-control-single' );
            if( $this->status == 'upgrade' ) return __( 'to be Upgrade Version.', 'woo-min-max-quantity-step-control-single' );
        }
        ...
        public function display_notice(){
            ...
            $recommend = $this->required ? __( 'Required for', 'woo-min-max-quantity-step-control-single' ) : __( 'Recommended by', 'woo-min-max-quantity-step-control-single' );
